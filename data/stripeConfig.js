...
(function () {
  const config = Object.freeze({
    ...
    checkoutFunctionName: "app667-crypto-monitor-create-checkout-session",
    verifyFunctionName: "app667-crypto-monitor-create-checkout-session",
    webhookFunctionName: "app667-crypto-monitor-stripe-webhook",
    defaultSuccessUrl: "",
    defaultCancelUrl: "",
    defaultPriceIds: [],
  });
